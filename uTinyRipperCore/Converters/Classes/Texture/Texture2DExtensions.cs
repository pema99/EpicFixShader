...
using uTinyRipper.TextureContainers.DDS;
using uTinyRipper.TextureContainers.KTX;
using uTinyRipper.TextureContainers.PVR;

using KTXFormat = uTinyRipper.TextureContainers.KTX.KTXInternalFormat;
using KTXBaseFormat = uTinyRipper.TextureContainers.KTX.KTXBaseInternalFormat;
using PVRFormat = uTinyRipper.TextureContainers.PVR.PVRPixelFormat;
